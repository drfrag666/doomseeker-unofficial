...
class ZandronumqGameExeFactory : public GameExeFactory
{
public:
	ZandronumqGameExeFactory(EnginePlugin *plugin);
	~ZandronumqGameExeFactory() override;

private:
	DPtr<ZandronumqGameExeFactory> d;
