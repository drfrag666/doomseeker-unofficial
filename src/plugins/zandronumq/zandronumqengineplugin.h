...
//------------------------------------------------------------------------------
#ifndef DOOMSEEKER_PLUGIN_ZANDRONUMQ_ENGINEPLUGIN_H
#define DOOMSEEKER_PLUGIN_ZANDRONUMQ_ENGINEPLUGIN_H

#include <dptr.h>
#include <plugins/engineplugin.h>

class ZandronumqEnginePlugin : public EnginePlugin
{
	DECLARE_PLUGIN(ZandronumqEnginePlugin)
public:
	ZandronumqEnginePlugin();
