...
namespace ZandronumqGameSettingsNames
{
...
const QString COMPAT_NO_PREDICTION_ACS = "CompatNoPredictionACS";
...
DClass<ZandronumqGameSettings>
{
public:
};
DPointered(ZandronumqGameSettings)
